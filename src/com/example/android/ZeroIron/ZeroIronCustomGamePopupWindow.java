...
public class ZeroIronCustomGamePopupWindow implements OnClickListener {
	...
	public ZeroIronCustomGamePopupWindow(View anchor, int rowId) {
		this.anchor = anchor;
		...
		this.window.setTouchInterceptor(new OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				if (event.getAction() == MotionEvent.ACTION_OUTSIDE) {
					ZeroIronCustomGamePopupWindow.this.window.dismiss();
					return true;
				}
				return false;
			}
...
*/
	...
	public void onClick(View arg0) {
		...
		if (b.getId() == R.id.editGameButton) {
			Toast.makeText(this.anchor.getContext(), "Edited!", Toast.LENGTH_SHORT).show();
			this.dismiss();
			ZeroIronGamesList gamesList = (ZeroIronGamesList)arg0.getContext();
			gamesList.editGameButtonClicked(rowId);
			return;
		}
		if (b.getId() == R.id.deleteGameButton) {
			Toast.makeText(this.anchor.getContext(), "Deleted!", Toast.LENGTH_SHORT).show();
			this.dismiss();
			ZeroIronGamesList gamesList = (ZeroIronGamesList)arg0.getContext();
			gamesList.deleteGameButtonClicked(rowId);
			return;
		}
	}
